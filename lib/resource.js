...
export class Resource {
  ...
  //TODO: the variable name should be more clear. providedSubmissionUri maybe?
  async canBeExported(submission) {
    ...
    for (const config of configurations) {
      const result = await getSubmissionInfo(this.uri, config.pathToSubmission, config.type, submission);
      if(result){
